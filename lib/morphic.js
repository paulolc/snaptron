...
Morph.prototype.setLeft = function (x) {
    ...
    //     var callStack = new Error('dummy').stack.replace(/\s*at ([a-zA-Z0-9\._<>]+) \(.*|\s*at [^ ]*/g,'$1;').split(';');
    //     var callerFuncName = callStack[1]; 
    //     if(  callerFuncName.match("spriteBar")  ){
    //         console.log( callStack.join(" <- ") );             
    //         console.log( callerFuncName +" setLeft: " + x);             
    //     }
